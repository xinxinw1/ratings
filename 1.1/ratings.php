...
?>
<?php $updated = "Jul.27.2013.23.55"; ?>
<!DOCTYPE html>
<html>

<head>
  <title>Ratings 1.1</title>
  <meta charset="UTF-8">
  <style type="text/css">
  * {margin: 0; padding: 0; border: 0 none;}
  ...
  <script src="../../events/2.x/events.js?<?php echo $updated ?>"></script>
  <script src="../../ajax/1.x/ajax.js?<?php echo $updated ?>"></script>
  <script src="../../prec-math/1.7.1/prec-math.js?<?php echo $updated ?>"></script>
