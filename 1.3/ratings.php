...
?>
<?php $updated = "Aug.17.2013.14.20"; ?>
<!DOCTYPE html>
<html>

<head>
  <title>Ratings 1.3</title>
  <meta charset="UTF-8">
  <style type="text/css">
  * {margin: 0; padding: 0; border: 0 none;}
  ...
  <script src="/codes/libjs/tools/1.x/tools.js?<?php echo $updated ?>"></script>
  <script src="/codes/libjs/events/3.x/events.js?<?php echo $updated ?>"></script>         
  <script src="/codes/libjs/ajax/2.x/ajax.js?<?php echo $updated ?>"></script>
  <script src="/codes/libjs/prec-math/2.x/prec-math.js?<?php echo $updated ?>"></script>
